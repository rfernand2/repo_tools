...
for name in ["wandb_api_key", "tpx_sql_pw", "openai_api_key", "azure_openai_api_key", "anthropic_api_key", "groq_api_key", "google_api_key", "together_api_key", "hyperbolic_api_key"]:
